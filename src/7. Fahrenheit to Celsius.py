...
here are two widespread systems of measuring temperature - Celsius and Fahrenheit. First is quite popular in Europe
...
Test Data:
35 528 519 257 595 287 335 318 305 213 194 468 233 447 170 561 279 476 85 199 513 458 349 195 325 341 385 93 442 350 465 151 277 384 377 272

"""

degrees = list(map(int, input().split()))
degrees.pop(0)
result = [str(round((degree-32) * (5/9))) for degree in degrees]
print(" ".join(result))
